    ...
    _connectServers(registerPeerHandlers)
    {
        this._config.forSelectedPoint((scheme, foreignServer) => {
            ...
            try {
                ...
                peer.close(4000, 'The connection couldn\'t be realized.');
                logger.info(`SFU "${scheme.getTargetId()}" could not be connected`);
                this._peers.delete(scheme.getTargetId());
            }
        });
    }
